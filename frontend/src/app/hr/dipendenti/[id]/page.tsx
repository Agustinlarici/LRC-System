...
export default function EmployeeDetailPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    const [empRes, depRes, allRes] = await Promise.all([
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            {employee.ruolo ?? 'Ruolo non specificato'} {employee.reparto_name ? `· ${employee.reparto_name}` : ''}
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-4">
          ...
          <Field label="Ruolo" value={employee.ruolo} />
